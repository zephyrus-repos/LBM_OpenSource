...
#ifndef LATTICE_EXTERNAL_3D_H
#define LATTICE_EXTERNAL_3D_H
...
public:
  SuperLatticeExternal3D(SuperLattice<T,DESCRIPTOR>& sLattice, size_t& iT);
};

/// BlockLatticeExternal3D returns pointwise density rho on local lattices.
template <typename T, typename DESCRIPTOR, typename FIELD>
class BlockLatticeExternal3D final : public BlockLatticeF3D<T,DESCRIPTOR> {
public:
  BlockLatticeExternal3D(BlockLattice<T,DESCRIPTOR>& blockLattice, size_t& iT);
