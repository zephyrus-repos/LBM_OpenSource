...
#ifndef OLB_REGULARIZED_HEAT_FLUX_3D_H
#define OLB_REGULARIZED_HEAT_FLUX_3D_H

#include "setBoundary.h"
#include "regularizedHeatFlux.h"
...
struct RegularizedHeatFlux<T,DESCRIPTOR,MixinDynamics> {
...
std::optional<DynamicsPromise<T,DESCRIPTOR>> getDynamics(DiscreteNormalType type,
  ...
  case DiscreteNormalType::Flat:
    return boundaryhelper::PlainMixinDynamicsForDirectionOrientationMomenta<
            T,DESCRIPTOR,CombinedAdvectionDiffusionRLBdynamics,MixinDynamics,
            momenta::RegularizedHeatFluxBoundaryTuple
    >::construct(n);

  case DiscreteNormalType::ExternalCorner:
    return boundaryhelper::NormalMixinDynamicsForPlainMomenta<
            T,DESCRIPTOR,AdvectionDiffusionCornerDynamics3D,MixinDynamics,
