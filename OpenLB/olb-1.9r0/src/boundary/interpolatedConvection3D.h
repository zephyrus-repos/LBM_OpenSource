...
#ifndef OLB_BOUNDARY_INTERPOLATED_CONVECTION_3D_H
#define OLB_BOUNDARY_INTERPOLATED_CONVECTION_3D_H

#include "interpolatedConvection.h"
...
struct InterpolatedConvection<T,DESCRIPTOR> {
  using value_t      = T;
  using descriptor_t = DESCRIPTOR;

  CellDistance getNeighborhoodRadius() { return 1; }
    ...
    switch (type) {
      case DiscreteNormalType::Flat:
        return boundaryhelper::promisePostProcessorForDirectionOrientation<
            T, DESCRIPTOR, StraightConvectionBoundaryProcessor3D>(n);
      default:
        return std::nullopt;
    }
  }
...
#endif //OLB_BOUNDARY_INTERPOLATED_CONVECTION_3D_H
