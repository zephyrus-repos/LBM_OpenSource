...
#ifndef GPU_HIP_CONTEXT_H
#define GPU_HIP_CONTEXT_H
...
class ConcreteParametersD<T,DESCRIPTOR,Platform::GPU_HIP,PARAMETERS> final
...
private:
  ...
  gpu::hip::device::unique_ptr<ParametersD> _deviceParameters;
