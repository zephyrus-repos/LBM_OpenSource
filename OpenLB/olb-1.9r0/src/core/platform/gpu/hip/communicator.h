...
#ifndef PLATFORM_GPU_HIP_COMMUNICATOR_H
#define PLATFORM_GPU_HIP_COMMUNICATOR_H
...
class HeterogeneousCopyTask<T,DESCRIPTOR,SOURCE,Platform::GPU_HIP>
...
class HeterogeneousCopyTask<T,DESCRIPTOR,Platform::GPU_HIP,TARGET>
...
template <typename T, typename DESCRIPTOR>
class ConcreteBlockCommunicator<ConcreteBlockLattice<T,DESCRIPTOR,Platform::GPU_HIP>>
