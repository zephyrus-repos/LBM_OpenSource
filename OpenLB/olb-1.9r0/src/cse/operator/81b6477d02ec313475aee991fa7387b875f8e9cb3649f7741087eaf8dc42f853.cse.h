...
auto x23 = V{3}*v_V3[1] - V{4}*v_V4[1] + V{1}*v_V5[1];
auto x27 = -x23*x26;
auto x37 = x23*x35;
...
auto x24 = V{3}*v_V6[2] - V{4}*v_V7[2] + V{1}*v_V8[2];
auto x28 = -x24*x26;
auto x29 = x20*x25 + x27 + x28;
auto x31 = x23*x25 + x28 + x30;
auto x32 = x24*x25 + x27 + x30;
