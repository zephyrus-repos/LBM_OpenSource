...
class SerializablePoiseuille2DTest : public ::testing::TestWithParam<TestParam> {
...
TEST_P(SerializablePoiseuille2DTest, testBGK)
{
  ...
  //initiatization of the first lattice, running the simulation up to the halfpoint and saving data
  {
    ...
    sLattice.save("SerializationTest2D");
  }
  ...
  //initialization of the second lattice, loading data of the first lattice and continuing the simulation
  {
    ...
    sLattice.load("SerializationTest2D");
    ...
    error(superGeometry, sLattice, converter, param);
  }
}

INSTANTIATE_TEST_CASE_P(BGKPoiseuille, SerializablePoiseuille2DTest,
