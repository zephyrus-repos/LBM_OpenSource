...
CXXFLAGS        += -Xcompiler -I/hkfs/home/software/all/toolkit/nvidia_hpc_sdk/23.9/Linux_x86_64/23.9/cuda/include
...
CUDA_LDFLAGS   :=  -L/hkfs/home/software/all/toolkit/nvidia_hpc_sdk/23.9/Linux_x86_64/23.9/cuda/lib64 \
		  -L/hkfs/home/software/all/toolkit/nvidia_hpc_sdk/23.9/Linux_x86_64/23.9/REDIST/cuda/12.2/targets/x86_64-linux/lib/stubs \


# for H100, see table in `rules.mk` for other options
CUDA_ARCH       := 90
