...
public:
  ...
  // ChildElementCount was originally suggested by msteiger on the sourceforge page for tinyxml2 and modified by KB1SPH for tinyxml2-2.
  ...
  */
  ...
  /** Accept a hierarchical visit of the nodes in the tinyxml2-2 DOM. Every node in the
      XML tree will be conditionally visited and the host will be called back
      via the XMLVisitor interface.

      This is essentially a SAX interface for tinyxml2-2. (Note however it doesn't re-parse
      the XML for the callbacks, so the performance of tinyxml2-2 is unchanged by using this
  ...
  /**
    Set user data into the XMLNode. tinyxml2-2 in
  ...
  */
  ...
  /**
    Get user data set into the XMLNode. tinyxml2-2 in
    no way processes or interprets user data.
    It is initially 0.
  */
...
/** In correct XML the declaration is the first entry in the file.
  ...
  tinyxml2-2 will happily read or write files without a declaration,
  however.
...
/** Any tag that tinyxml2-2 doesn't recognize is saved as an
...
public:
  ...
  /**
      ...
      specified, tinyxml2-2 will assume 'xml' points to a
  ...
  /**
      ...
      for providing and closing the FILE*.
        ...
        not text in order for tinyxml2-2 to correctly
...
/**
  ...
  an incredibly useful thing. Note that XMLHandle is not part of the tinyxml2-2
