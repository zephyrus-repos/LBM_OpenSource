...
auto x21 = x13*x19 + x20;
auto x22 = cell[6]*x10;
auto x23 = cell[7]*x10;
auto x24 = cell[8]*x10;
auto x25 = V{0.111111111111111}*x9;
auto x26 = V{0.166666666666667}*cell.template getFieldComponent<descriptors::FORCE>(0) + V{0.166666666666667}*x11 + x13*x25 + V{0.166666666666667}*x14 - x15 - V{0.0277777777777778}*x16*x9 + V{0.166666666666667}*x18 + V{0.166666666666667}*x22 + V{0.166666666666667}*x23 + V{0.166666666666667}*x24 + V{-0.166666666666667};
cell[0] = V{0.555555555555556}*cell.template getFieldComponent<descriptors::FORCE>(0)*x9 - x11 - V{0.444444444444444}*x13*x9;
cell[1] = -x14 - x17;
cell[2] = -x18 - x21;
cell[3] = x26;
cell[4] = V{0.666666666666667}*cell.template getFieldComponent<descriptors::FORCE>(0) + V{0.666666666666667}*x11 + V{0.444444444444444}*x13*x9 + V{0.666666666666667}*x14 - x16*x25 + V{0.666666666666667}*x18 - x20 + V{0.666666666666667}*x22 + V{0.666666666666667}*x23 + V{0.666666666666667}*x24 + V{-0.666666666666667};
cell[5] = x26;
cell[6] = -x21 - x22;
cell[7] = -x17 - x23;
cell[8] = V{0.111111111111111}*x16*x9 - x20 - x24;
