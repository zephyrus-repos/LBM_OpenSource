...
auto x31 = x26*x27 + x29 - x30;
auto x32 = x26*x28;
auto x33 = x20*x27 + x30 + x32;
auto x34 = x25*x27 + x29 - x32;
auto x38 = x26*x37;
auto x47 = x20*x41 + x38 + x46;
auto x51 = x26*x41;
auto x52 = x40 + x46 + x50 - x51;
auto x53 = -V{0.0833333333333333}*x21*x22*x25 + x39 + x50 + x51;
auto x36 = x35*(-V{0.5}*v_V0[0] + V{0.5}*v_V1[0] + V{1.5}*v_V5[1] - V{2}*v_V6[1] + V{0.5}*v_V7[1]);
auto x43 = x36 + x38 + x40 - x42;
auto x44 = -V{0.0833333333333333}*x21*x22*x26 + x36 + x39 + x42;
