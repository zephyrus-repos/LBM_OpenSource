...
template <concepts::BaseType T, concepts::LatticeDescriptor DESCRIPTOR>
ConstCell<T,DESCRIPTOR> Cell<T,DESCRIPTOR>::neighbor(Vector<int,DESCRIPTOR::d> c) const
{
  return ConstCell<T,DESCRIPTOR>(this->_block, this->_iCell + this->_block.getNeighborDistance(c));
}
