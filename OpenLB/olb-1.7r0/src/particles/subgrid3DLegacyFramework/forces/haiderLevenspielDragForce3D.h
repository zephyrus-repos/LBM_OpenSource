...
#ifndef HAIDERLEVENSPIELDRAGFORCE_3D_H
#define HAIDERLEVENSPIELDRAGFORCE_3D_H
...
class HaiderLevenspielDragForce3D : public Force3D<T, PARTICLETYPE> {
...
public:
  ...
  //HaiderLevenspielDragForce3D(HaiderLevenspielDragForce3D<T, PARTICLETYPE, DESCRIPTOR>& f);
