...
auto x22 = cell.template getFieldComponent<momenta::FixedVelocityMomentumGeneric::VELOCITY>(0);
auto x23 = cell.template getFieldComponent<momenta::FixedVelocityMomentumGeneric::VELOCITY>(1);
auto x25 = parameters.template get<descriptors::OMEGA>();
auto x24 = cell.template getFieldComponent<momenta::FixedVelocityMomentumGeneric::VELOCITY>(2);
auto x19 = x25 + V{-1};
auto x20 = x22 + V{-1};
auto x21 = -1/x20;
...
auto x125 = V{0.0555555555555556}*x25;
...
auto x147 = V{0.0277777777777778}*x25;
...
auto x0 = x19*(V{0.5}*cell[11] + V{0.5}*cell[12] + V{1}*cell[17] + V{1}*cell[18] + V{1}*cell[1] + V{0.5}*cell[2] + V{0.5}*cell[3] + V{1}*cell[8] + V{1}*cell[9] + x26 - x29*x40 - x29*x45 - x29*x48 - x29*x51 - x29*x54 - x29*x62 - x29*x67 - x29*x69 - x70*x73 - x70*x79 - x70*x84 - x70*x88 - x70*x92 - x94 + V{0.833333333333333}) - V{0.333333333333333}*x25*(-x21*x93*x99 + V{1});
auto x1 = -x125*(-x21*x73*x99 + V{1}) - x19*(V{0.00462962962962963}*x100*x27*x61 + V{0.00462962962962963}*x100*x27*x66 + V{0.00462962962962963}*x100*x27*x68 + V{0.037037037037037}*x100*x27*x72 - x102*x54 - x113 - x123 - x124);
auto x2 = -x125*(-x21*x48*x99 + V{1}) - x19*(V{0.166666666666667}*cell[11] + V{0.166666666666667}*cell[2] + x102*x50 - x103 - x104 + x105 + x107 - x109 - x111 - x112 - x126 - x127 + x128*x83 + x128*x91 + x129*x47 + x130*x40 + x136);
auto x3 = -x125*(-x21*x51*x99 + V{1}) - x19*(V{0.166666666666667}*cell[12] + V{0.166666666666667}*cell[3] + x102*x47 - x114 - x115 + x116 + x118 - x120 - x121 - x122 + x128*x78 + x128*x87 + x129*x50 + x130*x45 + x136 - x137 - x138);
auto x4 = -x147*(-x21*x88*x99 + V{1}) - x19*(x102*x87 + x146);
auto x5 = -x147*(-x21*x79*x99 + V{1}) - x19*(x102*x78 + x148);
auto x6 = -x147*(-x21*x92*x99 + V{1}) - x19*(x102*x91 + x151);
auto x7 = -x147*(-x21*x84*x99 + V{1}) - x19*(x102*x83 + x152);
auto x8 = -x147*(-x21*x69*x99 + V{1}) - x19*(x153*x54 + x154*x68 + x157);
auto x9 = -x147*(-x21*x67*x99 + V{1}) - x19*(-x153*x61 + x154*x66 + x158);
auto x10 = -x125*(-x162*x21*x99 + V{1}) + x19*(x103 + x104 + x106 + x108 + x114 + x115 + x117 + x119 + x124 + x159*x79 + x159*x84 + x159*x88 + x159*x92 - x160*x40 - x160*x45 - x160*x48 - x160*x51 - x160*x54 - x160*x62 - x160*x67 - x160*x69 - x162*x70 + V{0.0185185185185185}*x28*x73 + V{0.0555555555555555});
auto x11 = -x125*(-x21*x40*x99 + V{1}) - x19*(V{0.166666666666667}*cell[11] + V{0.166666666666667}*cell[2] + V{0.00925925925925926}*x100*x27*x83 + V{0.00925925925925926}*x100*x27*x91 - x113 - x126 - x127 - x129*x40 - x130*x47 - x163);
auto x12 = -x125*(-x21*x45*x99 + V{1}) - x19*(V{0.166666666666667}*cell[12] + V{0.166666666666667}*cell[3] + V{0.00925925925925926}*x100*x27*x78 + V{0.00925925925925926}*x100*x27*x87 - x123 - x129*x45 - x130*x50 - x137 - x138 - x163 + V{-0.0555555555555555});
auto x13 = -x147*(-x165*x21*x99 + V{1}) - x19*(x146 - x164*x165 - x166*x87);
auto x14 = -x147*(x169*x21*x99 + V{1}) - x19*(x148 + x164*x169 - x166*x78);
auto x15 = -x147*(-x170*x21*x99 + V{1}) - x19*(x151 - x164*x170 - x166*x91);
auto x16 = -x147*(x172*x21*x99 + V{1}) - x19*(x152 + x164*x172 - x166*x83);
auto x17 = -x147*(-x21*x54*x99 + V{1}) - x19*(-x153*x68 - x154*x54 + x157);
auto x18 = -x147*(-x21*x62*x99 + V{1}) - x19*(-x153*x66 + x154*x61 + x158);
cell.template getFieldPointer<descriptors::VELOCITY>()[0] = x22;
cell.template getFieldPointer<descriptors::VELOCITY>()[1] = x23;
cell.template getFieldPointer<descriptors::VELOCITY>()[2] = x24;
cell[0] = x0;
cell[1] = x1;
cell[2] = x2;
cell[3] = x3;
