...
auto x20 = V{3}*v_V0[0] - V{4}*v_V1[0] + V{1}*v_V2[0];
auto x32 = x20*x27;
auto x38 = x20*x37;
auto x42 = -x38;
...
auto x25 = V{3}*v_V3[1] - V{4}*v_V4[1] + V{1}*v_V5[1];
auto x28 = x25*x27;
auto x39 = x25*x37;
auto x43 = -x39;
...
auto x45 = x35*(V{1.5}*v_V0[2] - V{2}*v_V1[2] + V{0.5}*v_V2[2] + V{1.5}*v_V6[0] - V{2}*v_V7[0] + V{0.5}*v_V8[0]);
auto x50 = x35*(V{1.5}*v_V3[2] - V{2}*v_V4[2] + V{0.5}*v_V5[2] + V{1.5}*v_V6[1] - V{2}*v_V7[1] + V{0.5}*v_V8[1]);
auto x26 = V{3}*v_V6[2] - V{4}*v_V7[2] + V{1}*v_V8[2];
auto x29 = x26*x27;
