...
#ifndef LATTICE_SCHILLER_NAUMANN_DRAG_FORCE_H
#define LATTICE_SCHILLER_NAUMANN_DRAG_FORCE_H
...
/**
 *  \file latticeSchillerNaumannDragForce.h
 *  \brief $(Empirical drag force for spherical particles)
 *  Based on
 *  Schiller, L. and Naumann, A. (1935) A Drag Coefficient Correlation.
 *  Zeitschrift des Vereins Deutscher Ingenieure, 77, 318-320.
 */

template <typename T, typename DESCRIPTOR, typename PARTICLETYPE>
class BlockLatticeSchillerNaumannDragForce final : public BlockLatticePhysF<T,DESCRIPTOR> {
private:
  ...
  std::size_t _iP0;
public:
  BlockLatticeSchillerNaumannDragForce( BlockLattice<T,DESCRIPTOR>& blockLattice,
