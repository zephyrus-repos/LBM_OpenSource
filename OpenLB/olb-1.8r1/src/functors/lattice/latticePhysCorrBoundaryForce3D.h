...
public:
  SuperLatticePhysCorrBoundaryForce3D(SuperLattice<T,DESCRIPTOR>&      sLattice,
...
private:
  ...
  const BlockGeometry<T,3>& _blockGeometry;
public:
  BlockLatticePhysCorrBoundaryForce3D(BlockLattice<T,DESCRIPTOR>& blockLattice,
