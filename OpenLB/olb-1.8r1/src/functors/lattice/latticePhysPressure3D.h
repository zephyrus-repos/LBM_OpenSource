...
public:
  SuperLatticePhysPressure3D(SuperLattice<T,DESCRIPTOR>& sLattice,
                             const UnitConverter<T,DESCRIPTOR>& converter);
};

template <typename T, typename DESCRIPTOR>
SuperLatticePhysPressure3D(SuperLattice<T,DESCRIPTOR>&,
                           const UnitConverter<T,DESCRIPTOR>&)
  -> SuperLatticePhysPressure3D<T,DESCRIPTOR>;
...
public:
  BlockLatticePhysPressure3D(BlockLattice<T,DESCRIPTOR>& blockLattice,
                             const UnitConverter<T,DESCRIPTOR>& converter);
