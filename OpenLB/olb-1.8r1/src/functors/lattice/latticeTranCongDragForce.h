...
#ifndef LATTICE_TRAN_CONG_DRAG_FORCE_H
#define LATTICE_TRAN_CONG_DRAG_FORCE_H
...
/**
 *  \file latticeTranCongDragForce.h
 *  \brief $(TranCong drag force subgrid particle)
 *  Implementation of the Tran Cong force acting on subgrid non-spherical particles in ambient flow from
 *  Tran Cong S. , Drag coefficients of irregularly shaped particles , 2004
 *
 *
 */
template <typename T, typename DESCRIPTOR, typename PARTICLETYPE>
class BlockLatticeTranCongDragForce final : public BlockLatticePhysF<T,DESCRIPTOR> {
private:
  ...
  PhysR<T,DESCRIPTOR::d> _cellMin;//not used but needed due to templatisation
  PhysR<T,DESCRIPTOR::d> _cellMax;//not used but needed due to templatisation
  Vector<bool,DESCRIPTOR::d> _periodic;
  std::size_t _iP0;
public:
  BlockLatticeTranCongDragForce( BlockLattice<T,DESCRIPTOR>& blockLattice,
