...
#ifndef OLB_BOUNDARY_INTERPOLATED_CONVECTION_2D_H
#define OLB_BOUNDARY_INTERPOLATED_CONVECTION_2D_H
                                                                      ...
                                                                      DiscreteNormal<DESCRIPTOR> n)
  {
    switch (type) {
      ...
      return boundaryhelper::promisePostProcessorForDirectionOrientation<
          T, DESCRIPTOR, StraightConvectionBoundaryProcessor2D>(n);
      default:
        return std::nullopt;
    }
  }
...
#endif // OLB_BOUNDARY_INTERPOLATED_CONVECTION_2D_H
