...
#ifndef SEQUENTIAL_INTERPOLATION_F_3D_HH
#define SEQUENTIAL_INTERPOLATION_F_3D_HH
...
SpecialSequentialAnalyticalFfromBlockF3D<T,W>::SpecialSequentialAnalyticalFfromBlockF3D(
...
template <typename T, typename W>
bool SpecialSequentialAnalyticalFfromBlockF3D<T,W>::operator()(W output[],
    const T physC[])
{
...
template <typename T, typename W>
SequentialAnalyticalFfromBlockF3D<T,W>::SequentialAnalyticalFfromBlockF3D(
...
template <typename T, typename W>
bool SequentialAnalyticalFfromBlockF3D<T,W>::operator()(W output[], const T physC[])
{
  int latticeC[3];
  int latticeR[3];
...
template <typename T, typename W>
SequentialAnalyticalFfromSuperF3D<T,W>::SequentialAnalyticalFfromSuperF3D(SuperF3D<T,W>& f,
  ...
  if ( _f.getBlockFSize() == load.size() ) {
    for (int iC = 0; iC < load.size(); ++iC) {
      this->_blockF.emplace_back(
        new SequentialAnalyticalFfromBlockF3D<T>(_f.getBlockF(iC),
...
template <typename T, typename W>
bool SequentialAnalyticalFfromSuperF3D<T,W>::operator()(W output[], const T physC[])
{
  for (int iD = 0; iD < _f.getTargetDim(); ++iD) {
    output[iD] = W();
  }
...
template <typename T, typename W>
int SequentialAnalyticalFfromSuperF3D<T,W>::getBlockFSize() const
{
...
template <typename T, typename W>
SequentialAnalyticalFfromBlockF3D<T,W>& SequentialAnalyticalFfromSuperF3D<T,W>::getBlockF(int iCloc)
{
