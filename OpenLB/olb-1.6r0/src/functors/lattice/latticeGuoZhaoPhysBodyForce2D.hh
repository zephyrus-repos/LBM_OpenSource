  ...
  : SuperLatticePhysF2D<T, DESCRIPTOR>(sLattice, converter, 2)
{
  ...
  for (int iC = 0; iC < maxC; iC++) {
    this->_blockF.emplace_back(new BlockLatticeGuoZhaoPhysBodyForce2D<T,DESCRIPTOR>(this->_sLattice.getBlock(iC), this->_converter));
  }
}
...
{
  auto cell = this->_blockLattice.get(input[0], input[1]);
